...
13 . &nbsp; Qua  --  25/10  --  <span style="color:LightGray"> Diferenciabilidade exemplo 2. Função de classe $C^1$ e Difrenciais em $\mathbb{R}^2$.  </span> \
14 . &nbsp; Sex  --  27/10  --  <span style="color:LightGray"> Diferenciabilidade. Diferenciais em \mathbb{R}^3. </span> \
