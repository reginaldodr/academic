...
18 . &nbsp; Sex  --  17/11  --  <span style="color:LightGray"> Propriedades do vetor Gradiente. Derivação Implícita e Teorema da Função Implícita.  Derivação Implícita e Teorema da Função Implícita.  Valores Máximo e Mínimo. Pontos críticos. Teste da Derivada Segunda. Topologia do $\mathbb{R}^2$ </span> \
