...
01 . &nbsp; Qua  --  30/08  -- Apresentação. Funções Vetoriais. Limite e continuidade. Curvas parametrizadas no Plano.  \
02 . &nbsp; Sex  --  01/09  -- Resolução de Para Casa 1 e 2. Revisão de alguns conceitos de GA. Parametrização de Círcuos como interseção de duas superfícies. Definição de Coordenadas Polares.  \
03 . &nbsp; Qua  --  06/09  --  <span style="color:LightGray"> Curvas parametrizadas no Espaço. Derivadas e regras de derivação de funções vetoriais </span> \
<span style="color:orange"> XX . &nbsp; Qui  --  07/09  --  Independência </span> \
<span style="color:orange"> XX . &nbsp; Sex  --  08/09  --  Facultativo </span> \
04 . &nbsp; Qua  --  13/09  --  <span style="color:LightGray"> Comprimento de arco. Parametrização pelo comprimento de arco </span> \
05 . &nbsp; Sex  --  15/09  --  <span style="color:LightGray"> Curvatura, Vetores Normal e Binormal. </span> \
06 . &nbsp; Qua  --  20/09  --  <span style="color:LightGray"> Movimento, velocidade e aceleração. Componentes Normal e Tangencial da Aceleração </span> \
07 . &nbsp; Sex  --  22/09  --  <span style="color:LightGray"> Aula de Dúvidas </span> \
<span style="color:red"> 08 . &nbsp; Qua  --  27/09  --  1ª Prova </span> \
09 . &nbsp; Sex  --  29/09  --  <span style="color:LightGray"> Definição de Funções de Várias Variáveis. Gráficos de funções de 2 variáveis </span> \
10 . &nbsp; Qua  --  04/10  --  <span style="color:LightGray"> Curvas de Nível. Superfícies de nível. Limites e continuidade </span> \
11 . &nbsp; Sex  --  06/10  --  <span style="color:LightGray"> Superfícies de nível. Limites e continuidade </span> \
12 . &nbsp; Qua  --  11/10  --  <span style="color:LightGray"> Derivadas Parciais. Derivadas de ordem superior </span> \
...
13 . &nbsp; Qua  --  25/10  --  <span style="color:LightGray"> Equações Diferenciais Parciais. Plano tangente. Aproximação linear  </span> \
14 . &nbsp; Sex  --  27/10  --  <span style="color:LightGray"> Diferenciabilidade. Diferenciais no plano e no espaço </span> \
<span style="color:orange"> XX . &nbsp; Sáb  --  28/10  --  Servidor Público </span> \
15 . &nbsp; Qua  --  01/11  --  <span style="color:LightGray"> Regra da cadeia. Vetor Gradiente </span> \
<span style="color:orange"> XX . &nbsp; Qui  --  02/11  --  Finados </span> \
<span style="color:orange"> XX . &nbsp; Sex  --  03/11  --  Facultativo </span> \
16 . &nbsp; Qua  --  08/11  --  <span style="color:LightGray"> Derivadas direcionais. Propriedades do vetor Gradiente </span> \
17 . &nbsp; Sex  --  10/11  --  <span style="color:LightGray"> Derivação Implícita e Teorema da Função Implícita </span> \
<span style="color:orange"> XX . &nbsp; Qua  --  15/11  --  Proclamação da República </span> \
18 . &nbsp; Sex  --  17/11  --  <span style="color:LightGray"> Valores Máximo e Mínimo. Pontos críticos. Teste da Derivada Segunda. Topologia do $\mathbb{R}^2$ </span> \
<span style="color:orange"> XX . &nbsp; Seg  --  20/11  --  Consciência Negra </span> \
19 . &nbsp; Qua  --  22/11  --  <span style="color:LightGray"> Máximos e Mínimos absolutos. Teorema de Weiestrass. </span> \
20 . &nbsp; Sex  --  24/11  --  <span style="color:LightGray"> Multiplicadores de Lagrange em $\mathbb{R}^2$. Multiplicadores de Lagrange em $\mathbb{R}^3$ </span> \
21 . &nbsp; Qua  --  29/11  --  <span style="color:LightGray"> Multiplicadores de Lagrange com duas restrições </span> \
