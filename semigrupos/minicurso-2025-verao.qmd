...
\
04 . &nbsp; Qua  --  19/02  --  <span style="color:gray"> Espectro de um semigrupo. Resolvente de um operador. Teorema do Gráfico Fechado.  </span> \
\
05 . &nbsp; Qui  --  20/02  --  <span style="color:gray"> Semigrupos das Contrações. Aproximação de Yosida. O Teorema de Hille-Yosida para contrações. </span> \
\
06 . &nbsp; Sex  --  21/02  --  <span style="color:gray"> Teorema de Hille-Yosida (continuação). Aplicações em EDPs. Perspectivas de Pesquisa. </span> \
