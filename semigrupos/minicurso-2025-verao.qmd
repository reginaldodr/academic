...
\
02 . &nbsp; Qui  --  13/02  --  <span style="color:standard">  Definição de Semigrupos de classe $C^0$. Propriedades. Gerador Infinitesimal de um Semigrupo. Existência e Unicidade do PVI para geradores infinitesimais. </span> \
\
03 . &nbsp; Sex  --  14/02  --  <span style="color:standard"> Gerador Infinitesimal. Existência e Unicidade para o PVI. Propriedades. </span> \
\
04 . &nbsp; Qua  --  19/02  --  <span style="color:gray"> Resolvente de um operador.  Semigrupos das Contrações. O Teorema de Hille-Yosida. </span> \
\
05 . &nbsp; Qui  --  20/02  --  <span style="color:gray"> Operadores dissipativos. Teorema de Lumer-Philips. </span> \
\
06 . &nbsp; Sex  --  21/02  --  <span style="color:gray"> Aplicações em EDPs. Perspectivas de Pesquisa. </span> \
