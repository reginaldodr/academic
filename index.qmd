...
about:
  ...
  links:
    ...
    - icon: envelope-at
      text: email
      href: mailto:reginaldodr@disroot.com
    - icon: youtube
      text: YouTube
...
![Campus de Rio das Ostras](images/uff-ihs.jpg){width=60%}
...
|-------|:------:|:------:|:------:|:------:|:------:|
|9h - 11h| <span style="color:green">  Cálculo III-A </span>  <br> Sala S01 IHS<br> Prédio Alugado|  <span style="color:green">  Cálculo III-A </span>  <br>  Sala S01 IHS<br> Prédio Alugado| | | |
|11h - 13h|<span style="color:blue">  Cálculo III </span>  <br> Sala S01 IHS<br> Prédio Alugado|<span style="color:blue">  Cálculo III </span>  <br> Sala S01 IHS<br> Prédio Alugado| | |  <br> 
: {.striped .table-sm}
...
- [Calendário UFF](https://www.uff.br/wp-content/uploads/2025/11/RESOLUCAO-CEPEX-5309_12-11-2025_CALENDARIO-ESCOLAR-E-ADMINISTRATIVO-2026.pdf)
    ...
    - 2º Período letivo: 03/08/2026 a 11/12/2026.

- [iduff](https://app.uff.br/iduff/)

- [Quadro de Horários](https://app.uff.br/graduacao/quadrodehorarios)

- [Quadro de Alocação de salas do ICT](http://200.159.243.250:8015/) 
...
![Campus de Niterói](/images/pgmat-uff.jpg){width=70%}
