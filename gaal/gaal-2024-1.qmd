...
@santosufmg **3.3:** 2, 3, 4, 5, 7.\
@santosufmg **4.3:** 8, 9.\
@santosufmg **5.1:** 1, 3, 4, 8.\
...
18 . &nbsp; Seg  --  05/08  --  <span style="color:LightGray"> Projeção Ortogonal. Bases Ortogonais e Ortonormais. Autovetores e Autovalores </span> \
19 . &nbsp; Ter  --  06/08  --  <span style="color:LightGray"> Diagonalização de Matrizes </span> \
20 . &nbsp; Seg  --  12/08  --  <span style="color:LightGray"> Diagonalização de Matrizes Simétricas. Mudança de Coordenadas. Rotação e Translação. </span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
---
