...
1. Exercícios propostos, chamados de **Para Casa** :house: , que deverão ser entregues ao final de cada módulo.
...
- Tema: Cônicas: Elipse, hipérbole e parábola
    - **Referências:** Seção 10.5 da referência [@stewart2] . Videoaulas: [Integrais Impróprias](https://youtu.be/UqpxSNmyGPI) 
- Deverá ser feito em grupos de 4 a 5 integrantes.
- Deverá ser manuscrito.
- Deverá ser entregue no dia . 
...
**1.1 Vetores, Matrizes e sistemas Lineares**
