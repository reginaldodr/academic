...
- [Material a ser utilizado](gaal.qmd)
...
02 . &nbsp; Ter  --  19/03  --  <span style="color:LightGray"> O espaço vetorial $\mathbb{R}^3$ e representação geométrica. O espaço vetorial $\mathbb{R}^n$. Norma e vetor unitário. Combinação Linear. </span> \
