...
19 . &nbsp; Ter  --  06/08  --  <span style="color:LightGray">  Autoespaços. Matrizes semelhantes. Diagonalização de Matrizes. </span> \
20 . &nbsp; Seg  --  12/08  --  <span style="color:LightGray"> Diagonalização de Matrizes Simétricas. Mudança de Coordenadas. Rotação e Translação. Projeção Ortogonal. Bases Ortogonais e Ortonormais.</span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
---
