...
05 . &nbsp; Seg  --  01/04  --  <span style="color:LightGray"> Demonstração fórmula do ângulo. Equação paramétrica da reta.  </span> \
06 . &nbsp; Ter  --  02/04  --  <span style="color:LightGray"> Equações Cartesianas da Reta em $\mathbb{R}^2$. Equação cartesina do Plano em $\mathbb{R}^3$.   </span> \
