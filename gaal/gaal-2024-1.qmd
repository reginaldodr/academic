...
@poole **§ 3.4:** 49, 53, 57, 51, 55, 45, 20, 21.\
@poole **§ 4.3:** 1, 3, 5, 7, 9, 13, 27, 29, 33, 47, 49, 51.\
...
06 . &nbsp; Ter  --  02/04  --  <span style="color:Black"> Equações Cartesianas da Reta em $\mathbb{R}^2$: parte 2.  Equação cartesina do Plano em $\mathbb{R}^3$. Sistemas de Equações Lineares. Operações Elementares.  </span> \
07 . &nbsp; Seg  --  08/04  --  <span style="color:Black">  Escalonamento. Posto de uma matriz. Variáveis livres. Usando sympy para resolver sistemas lineares.</span> \
08 . &nbsp; Ter  --  09/04  --  <span style="color:Black">  Método de Gauss-Jordan. </span> \
...
09 . &nbsp; Ter  --  16/04  --  <span style="color:Black"> Sistemas lineares Homogêneos. Matriz Inversa e Método de Inversão.  </span> \
...
10 . &nbsp; Seg  --  29/04  --  <span style="color:LightGray"> Propriedades da Inversa. Invertendo matrizes com o sympy. Determinantes. </span> \
11 . &nbsp; Ter  --  30/04  --  <span style="color:LightGray">  Produto Vetorial e Produto Misto. Distâncias: entre Ponto e Plano, Ponto a Reta </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Qua  --  01/05  --  Dia do Trabalho </span> \
12 . &nbsp; Seg  --  06/05  --  <span style="color:LightGray"> Distâncias: Entre Retas, entre reta e Plano </span> \
...
13 . &nbsp; Ter  --  07/05  --  <span style="color:LightGray"> Dependência e Independência Linear </span> \
14 . &nbsp; Seg  --  13/05  --  <span style="color:LightGray"> Posição Relativa de retas e planos </span> \
15 . &nbsp; Ter  --  14/05  --  <span style="color:LightGray"> Subespaço. Base e Dimensão </span> \
16 . &nbsp; Seg  --  20/05  --  <span style="color:LightGray"> Aula de Exercícios </span> \
17 . &nbsp; Ter  --  21/05  --  <span style="color:LightGray"> Projeção Ortogonal. Bases Ortogonais e Ortonormais. </span> \
18 . &nbsp; Seg  --  27/05  --  <span style="color:LightGray"> Mudança de Coordenadas. Rotação e Translação </span> \
19 . &nbsp; Ter  --  28/05  --  <span style="color:LightGray"> Autovetores e Autovalores </span> \
...
20 . &nbsp; Seg  --  03/06  --  <span style="color:LightGray"> Diagonalização de Matrizes </span> \
21 . &nbsp; Ter  --  04/06  --  <span style="color:LightGray"> Diagonalização de Matrizes Simétricas </span> \
22 . &nbsp; Seg  --  10/06  --  <span style="color:LightGray"> Reconhecimento de Cônicas </span> \
23 . &nbsp; Ter  --  11/06  --  <span style="color:LightGray"> Aula de Exercícios </span> \
24 . &nbsp; Seg  --  17/06  --  <span style="color:LightGray"> Aula de Dúvidas </span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
---

**Provas Finais**

<span style="color:red"> 25 . &nbsp; Ter  --  18/06  --  Prova da Matéria Toda </span> \
26 . &nbsp; Seg  --  24/06  --  <span style="color:LightGray"> Vista da Prova. </span> \
<span style="color:red"> 27 . &nbsp; Ter  --  25/06  --  2ª Chamada </span> \
28 . &nbsp; Seg  --  01/07  --  <span style="color:LightGray"> Semana dedicada à preparação para a VS </span> \
29 . &nbsp; Ter  --  02/07  --  <span style="color:LightGray"> Semana dedicada à preparação para a VS </span> \
<span style="color:red"> 30 . &nbsp; Seg  --  08/07  --  VS </span> \
31 . &nbsp; Ter  --  09/07  --  <span style="color:LightGray">  --  </span> \
32 . &nbsp; Seg  --  15/07  --  <span style="color:LightGray">  --  </span> \
33 . &nbsp; Ter  --  16/07  --  <span style="color:LightGray">  --  </span> \
