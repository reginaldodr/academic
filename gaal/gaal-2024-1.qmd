...
Inicialmente foram **49 inscritos**, entretanto ao final do curso ficamos com **36** estudantes. Isso se deu pois, devido à greve neste período, O CEPEx aprovou novo calendário estendendo os período de trancamento de disciplina.   veja a [Resolução CEPEx/UFF nº 3618](https://www.uff.br/sites/default/files/paginas-internas-orgaos/87-24_res_cepex_3.618_calendarios_2024_p._greve.pdf).
...
data = np.array([0,2.8,6,6.9,7.1,6.1,5.3,6.,2.4,7.6,0,6.5,8.1,10,0,7.6,3.4,0,6,0.8,4.8,9.4,8.4,6.3,0.8,0,3.3,4.6,2.9,6.2,7.7,4.3,0,1.8,1.9,9.8])

# Fit a normal distribution to the data:
mu, std = norm.fit(data)

# Plot the histogram.
plt.hist(data, bins=5, density=False, alpha=0.6, color='b',edgecolor='black')

# Adicionar título e legendas
plt.title("Histograma das Notas (Frequência Absoluta)")
plt.xlabel('Notas')
