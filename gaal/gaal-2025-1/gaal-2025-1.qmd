...
A avaliação será feita mediante **3 Verificações de Aprendizagem (Provas Escritas)**. A nota parcial (NP) será a média ponderada entre elas, dada da seguinte forma:
$$
NP=0.2\cdot VA_1+ 0.3\cdot VA_2+0.5\cdot VA_3,
$$
onde $VA_i$ é a nota da $i$-ésima Verificação de Aprendizagem. De acordo com o Regulamento da UFF, a **Nota Final** é calculada da seguinte forma:
...
<span style="color:red"> 31 . &nbsp; Seg  --  14/07  --  2ª Chamada -- Matéria: todo o conteúdo do curso. </span> -- [gabarito](../provas/2025-1-vr-turmaK1-gaal-gabarito.pdf)\
...
[gabarito](../provas/2025-1-vs-turmaK1-gaal-gabarito.pdf) \
