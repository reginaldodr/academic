...
22 . &nbsp; Ter  --  10/06  --  <span style="color:DarkGray"> Subespaço vetorial. Subespaço gerado. Base e Dimensão. Núcleo de uma matriz.   </span> \
23 . &nbsp; Seg  --  16/06  --  <span style="color:DarkGray">Espaço linha e Espaço coluna. Como obter bases de subespaços. Definição de Autovetores e Autovalores. Autoespaços. Matrizes semelhantes. Diagonalização de Matrizes. </span> \
