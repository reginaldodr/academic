...
15 . &nbsp; Seg  --  19/05  --  <span style="color:DarkGray"> Método de Gauss-Jordan. Sistemas Lineares Homogêneos. Matriz inversa e Método de inversão. Propriedades da Inversa. </span> \
---

**2. Álgebra Linear no $\mathbb{R}^n$**

16 . &nbsp; Ter  --  20/05  --  <span style="color:DarkGray"> Não haverá aula </span> \
17 . &nbsp; Seg  --  26/05  --  <span style="color:DarkGray"> Definição de Determinantes.  Propriedades dos Determinantes. Cálculo de determinantes por redução por linhas. </span> \
18 . &nbsp; Ter  --  27/05  --  <span style="color:DarkGray">  Definição de Produto Vetorial. Propriedades do Produto Vetorial. Produto Misto. Volumes do Paralelepípedo. </span> \
<span style="color:red"> 19 . &nbsp; Seg  --  02/06  --  2ª Prova </span> \
20 . &nbsp; Ter  --  03/06  --  <span style="color:DarkGray"> Dependência e Independência Linear.  Subespaço vetorial. Subespaço gerado. Base e Dimensão </span> \
