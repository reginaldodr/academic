...
05 . &nbsp; Seg  --  07/04  --  <span style="color:DarkGray">Propriedades das operações com matrizes. Matrizes identidade e transposta. Operações usando o sympy. Produto escalar no $\mathbb{R}^n$. Ângulo entre vetores. Produto escalar usando o sympy. </span> \
06 . &nbsp; Ter  --  08/04  --  <span style="color:DarkGray"> Demonstração da Fórmula do ângulo. Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$ </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Qui  --  10/04  --  Feriado Municipal </span> \
07 . &nbsp; Seg  --  14/04  --  <span style="color:DarkGray"> Equações Cartesianas da Reta em $\mathbb{R}^2$ continuação. Equação cartesina do Plano em $\mathbb{R}^3$. Sistemas de Equações Lineares. Operações Elementares. </span> \
