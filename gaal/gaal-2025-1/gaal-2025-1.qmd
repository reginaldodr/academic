...
06 . &nbsp; Ter  --  08/04  --  <span style="color:DarkGray"> Operações usando o sympy. Produto escalar no $\mathbb{R}^n$. Ângulo entre vetores. Produto escalar usando o sympy. Demonstração da Fórmula do ângulo. Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$ </span> \
