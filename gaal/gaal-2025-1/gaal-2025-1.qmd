...
::: {.column width="40%"}
  ...
  - [Notas das aulas](https://mega.nz/folder/DFdF3JYK#I-B7O1gBR4zCX_yrDnQWzA)
...
03 . &nbsp; Seg  --  31/03  --  <span style="color:LightGray"> Representação Geométrica. Norma. Regra do paralelogramo. O espaço vetorial $\mathbb{R}^3$ e representação geométrica. O espaço vetorial $\mathbb{R}^n$. Norma e vetor unitário. Combinação Linear. </span> \
