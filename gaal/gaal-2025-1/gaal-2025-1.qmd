...
A avaliação será feita mediante **Duas Provas Escritas**. A nota final será a média aritmética entre elas.
...
Com base nos objetivos apresentados acima, os critério de correção serão: 
   ...
   3. As soluções devem ser fundamentadas no conteúdo ensinado em aula. Soluções fora do conteúdo ensinado, mesmo que corretas, não serão consideradas, tendo em vista que o objetivo das avaliações é verificar se o conteúdo ensinado foi aprendido. 
