...
25 . &nbsp; Seg  --  23/06  --  <span style="color:DarkGray">Diagonalização de Matrizes. Exemplos de Diagonalização. Projeção Ortogonal. Bases Ortogonais e Ortonormais.  Matrizes Ortogonais. Teorema Espectral. </span> \
...
4. Processo de Ortogonalização de Gram-Schimidt.
