...
12 . &nbsp; Ter  --  06/05  --  <span style="color:DarkGray"> Equações da reta. Equação cartesina do Plano em $\mathbb{R}^3$.  Sistemas de Equações Lineares. Operações Elementares. Matriz aumentada. Escalonamento.  </span> \
13 . &nbsp; Seg  --  12/05  --  <span style="color:DarkGray"> Posto de uma matriz. Variáveis livres. Teorema do Posto. Classificação. Método de Gauss-Jordan. Usando sympy para resolver sistemas lineares.  </span> \
14 . &nbsp; Ter  --  13/05  --  <span style="color:DarkGray">Sistemas Lineares Homogêneos. Matriz inversa e Método de inversão. Propriedades da Inversa. Invertendo matrizes com o sympy. </span> \
15 . &nbsp; Seg  --  19/05  --  <span style="color:DarkGray"> Definição de Determinantes.  Propriedades dos Determinantes. Cálculo de determinantes por redução por linhas.   </span> \
---

**2. Álgebra Linear no $\mathbb{R}^n$**

16 . &nbsp; Ter  --  20/05  --  <span style="color:DarkGray">Definição de Produto Vetorial. Propriedades do Produto Vetorial. Produto Misto. Volumes do Paralelepípedo. Distâncias: entre Ponto e Plano.  </span> \
17 . &nbsp; Seg  --  26/05  --  <span style="color:DarkGray"> Distância de ponto à Reta. Distâncias: Entre Retas, entre reta e Plano. </span> \
18 . &nbsp; Ter  --  27/05  --  <span style="color:DarkGray"> Dependência e Independência Linear. Posição Relativa de retas e planos. Subespaço vetorial. </span> \
