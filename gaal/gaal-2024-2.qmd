...
1. Exercícios propostos em aula, chamados de **Para Casa** :house: [veja aqui](paracasa.pdf), que deverão ser entregues de acordo com o cronograma na seção @sec-crono.
...
- Datas de entregas ver @sec-crono. 
...
**1. Matrizes, Sistemas lineares, Determinates;**

01 . &nbsp; Seg  --  30/09  --  <span style="color:standard"> Apresentação. Matrizes: definição, operações e propriedades. Matrizes identidade e transposta. Operações usando o sympy. </span> \
...
<span style="color:red"> 09 . &nbsp; Ter  --  05/11  --  1ª Prova </span> \
---

**2. Álgebra Linear no $\mathbb{R}^n$**

10 . &nbsp; Seg  --  11/11  --  <span style="color:standard"> O espaço vetorial $\mathbb{R}^n$. Norma e vetor unitário. Produto escalar no $\mathbb{R}^n$. Produto escalar usando o sympy. </span> \
11 . &nbsp; Ter  --  12/11  --  <span style="color:standard"> Dependência e Independência Linear </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sex  --  15/11  --  Proclamação da República </span> \
12 . &nbsp; Seg  --  18/11  --  <span style="color:standard"> Posição Relativa de retas e planos </span> \
13 . &nbsp; Ter  --  19/11  --  <span style="color:standard"> Subespaço veorial. Subespaço gerado. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Qua  --  20/11  --  Consciência Negra </span> \
14 . &nbsp; Seg  --  25/11  --  <span style="color:standard"> Base e Dimensão </span> \
15 . &nbsp; Ter  --  26/11  --  <span style="color:standard"> Núcleo de uma matriz.Espaço linha e Espaço coluna. </span> \
16 . &nbsp; Seg  --  02/12  --  <span style="color:standard"> Como obter bases de subespaços. Definição de Autovetores e Autovalores  </span> \
17 . &nbsp; Ter  --  03/12  --  <span style="color:standard"> Autoespaços. Matrizes semelhantes. Diagonalização de Matrizes. Exemplos de Diagonalização. Diagonalizando com sympy. </span> \
18 . &nbsp; Seg  --  09/12  --  <span style="color:standard"> Projeção Ortogonal. Bases Ortogonais e Ortonormais. </span> \
19 . &nbsp; Ter  --  10/12  --  <span style="color:standard"> Processo de Ortogonalização de Gram-Schimidt </span> \
20 . &nbsp; Seg  --  16/12  --  <span style="color:standard"> Diagonalização de Matrizes Simétricas </span> \
21 . &nbsp; Ter  --  17/12  --  <span style="color:standard"> Mudança de Coordenadas. Rotação e Translação </span> \
...
22 . &nbsp; Seg  --  06/01  --  <span style="color:standard"> Reconhecimento de Cônicas </span> \
<span style="color:red"> 23 . &nbsp; Ter  --  07/01  --  2ª Prova </span> \
---

**Provas Finais**

<span style="color:red"> 24 . &nbsp; Seg  --  13/01  --  2ª Chamada </span> \
<span style="color:red"> 25 . &nbsp; Ter  --  14/01  --  VS </span> \
26 . &nbsp; Seg  --  20/01  --  <span style="color:standard">  --  </span> \
27 . &nbsp; Ter  --  21/01  --  <span style="color:standard">  --  </span> \
28 . &nbsp; Seg  --  27/01  --  <span style="color:standard">  --  </span> \
