...
1. Exercícios propostos em aula, chamados de **Para Casa** :house: [veja aqui](paracasa.pdf).
...
$$N=0.1\times PC+0.1\times AF+0.8\times P,$$
...
01 . &nbsp; Seg  --  30/09  --  <span style="color:standard"> Apresentação do curso. Matrizes: definição, operações e propriedades. Matrizes identidade e transposta. Operações usando o sympy. </span> \
02 . &nbsp; Ter  --  01/10  --  <span style="color:LightGray"> Sistemas de Equações Lineares. Operações Elementares. Escalonamento. </span> \
03 . &nbsp; Seg  --  07/10  --  <span style="color:LightGray"> Posto de uma matriz. Variáveis livres. Método de Gauss-Jordan. Usando sympy para resolver sistemas lineares. </span> \
04 . &nbsp; Ter  --  08/10  --  <span style="color:LightGray"> Sistemas lineares Homogêneos. Matriz Inversa e Método de Inversão </span> \
...
05 . &nbsp; Seg  --  21/10  --  <span style="color:LightGray"> Propriedades da Inversa. Invertendo matrizes com o sympy. Definição de Determinantes. </span> \
06 . &nbsp; Ter  --  22/10  --  <span style="color:LightGray"> Propriedades dos Determinantes. Cálculo de Determinante por Redução por linhas. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  28/10  --  Servidor Público </span> \
07 . &nbsp; Ter  --  29/10  --  <span style="color:LightGray"> Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  02/11  --  Finados </span> \
08 . &nbsp; Seg  --  04/11  --  <span style="color:LightGray"> Equação cartesina do Plano em $\mathbb{R}^3$.Distância de ponto à Reta. Distâncias: Entre Retas, entre reta e Plano </span> \
09 . &nbsp; Ter  --  05/11  --  <span style="color:LightGray"> Aula de Exercícios 1 </span> \
<span style="color:red"> 10 . &nbsp; Seg  --  11/11  --  1ª Prova </span> \
---

**2. Álgebra Linear no $\mathbb{R}^n$**

11 . &nbsp; Ter  --  12/11  --  <span style="color:LightGray"> O espaço vetorial $\mathbb{R}^n$. Norma e vetor unitário. Produto escalar no $\mathbb{R}^n$. Produto escalar usando o sympy. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sex  --  15/11  --  Proclamação da República </span> \
12 . &nbsp; Seg  --  18/11  --  <span style="color:LightGray"> Dependência e Independência Linear </span> \
13 . &nbsp; Ter  --  19/11  --  <span style="color:LightGray"> Posição Relativa de retas e planos </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Qua  --  20/11  --  Consciência Negra </span> \
14 . &nbsp; Seg  --  25/11  --  <span style="color:LightGray"> Subespaço vetorial. Subespaço gerado. </span> \
15 . &nbsp; Ter  --  26/11  --  <span style="color:LightGray"> Base e Dimensão </span> \
16 . &nbsp; Seg  --  02/12  --  <span style="color:LightGray"> Núcleo de uma matriz. Espaço linha e Espaço coluna. </span> \
17 . &nbsp; Ter  --  03/12  --  <span style="color:LightGray"> Como obter bases de subespaços. Definição de Autovetores e Autovalores  </span> \
18 . &nbsp; Seg  --  09/12  --  <span style="color:LightGray"> Autoespaços. Matrizes semelhantes. Diagonalização de Matrizes. Exemplos de Diagonalização. Diagonalizando com sympy. </span> \
19 . &nbsp; Ter  --  10/12  --  <span style="color:LightGray"> Projeção Ortogonal. Bases Ortogonais e Ortonormais. </span> \
20 . &nbsp; Seg  --  16/12  --  <span style="color:LightGray"> Processo de Ortogonalização de Gram-Schimidt </span> \
21 . &nbsp; Ter  --  17/12  --  <span style="color:LightGray"> Diagonalização de Matrizes Simétricas </span> \
...
22 . &nbsp; Seg  --  06/01  --  <span style="color:LightGray"> Mudança de Coordenadas. Rotação e Translação </span> \
23 . &nbsp; Ter  --  07/01  --  <span style="color:LightGray"> Reconhecimento de Cônicas </span> \
24 . &nbsp; Seg  --  13/01  --  <span style="color:LightGray"> Aula de Exercícios 2 </span> \
<span style="color:red"> 25 . &nbsp; Ter  --  14/01  --  2ª Prova </span> \
---

**Provas Finais**

<span style="color:red"> 26 . &nbsp; Seg  --  20/01  --  2ª Chamada </span> \
27 . &nbsp; Ter  --  21/01  --  <span style="color:LightGray"> Atendimento </span> \
...
:beach_umbrella: <span style="color:orange"> &nbsp; Ter  --  24/09  --  Participação em Congresso --  Não houve aula </span> \
01 . &nbsp; Seg  --  30/09  --  <span style="color:standard"> Apresentação do curso. Matrizes: definição, operações e propriedades. Matrizes identidade e transposta. Operações usando o sympy. </span> \
02 . &nbsp; Ter  --  01/10  --  <span style="color:standard"> Sistemas de Equações Lineares. Operações Elementares. Escalonamento. </span> \
03 . &nbsp; Seg  --  07/10  --  <span style="color:standard"> Posto de uma matriz. Variáveis livres. Método de Gauss-Jordan. Usando sympy para resolver sistemas lineares. </span> \
04 . &nbsp; Ter  --  08/10  --  <span style="color:standard"> Sistemas lineares Homogêneos. Matriz Inversa e Método de Inversão </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  12/10  --  Nossa Senhora Aparecida </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  14/10  --  Semana Nacional de Ciência e Tecnologia </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Ter  --  15/10  --  Semana Nacional de Ciência e Tecnologia </span> \
05 . &nbsp; Seg  --  21/10  --  <span style="color:standard"> Propriedades da Inversa. Invertendo matrizes com o sympy. Definição de Determinantes. </span> \
06 . &nbsp; Ter  --  22/10  --  <span style="color:standard"> Propriedades dos Determinantes. Cálculo de Determinante por Redução por linhas. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  28/10  --  Servidor Público </span> \
07 . &nbsp; Ter  --  29/10  --  <span style="color:standard"> Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  02/11  --  Finados </span> \
08 . &nbsp; Seg  --  04/11  --  <span style="color:standard"> Equação cartesina do Plano em $\mathbb{R}^3$.Distância de ponto à Reta. Distâncias: Entre Retas, entre reta e Plano </span> \
09 . &nbsp; Ter  --  05/11  --  <span style="color:standard"> Aula de Exercícios 1 </span> \
<span style="color:red"> 10 . &nbsp; Seg  --  11/11  --  1ª Prova </span> \
---

**2. Álgebra Linear no $\mathbb{R}^n$**

11 . &nbsp; Ter  --  12/11  --  <span style="color:standard"> O espaço vetorial $\mathbb{R}^n$. Norma e vetor unitário. Produto escalar no $\mathbb{R}^n$. Produto escalar usando o sympy. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sex  --  15/11  --  Proclamação da República </span> \
12 . &nbsp; Seg  --  18/11  --  <span style="color:standard"> Dependência e Independência Linear </span> \
13 . &nbsp; Ter  --  19/11  --  <span style="color:standard"> Posição Relativa de retas e planos </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Qua  --  20/11  --  Consciência Negra </span> \
14 . &nbsp; Seg  --  25/11  --  <span style="color:standard"> Subespaço vetorial. Subespaço gerado. </span> \
15 . &nbsp; Ter  --  26/11  --  <span style="color:standard"> Base e Dimensão </span> \
...
18 . &nbsp; Seg  --  09/12  --  <span style="color:standard"> Autoespaços. Matrizes semelhantes. Diagonalização de Matrizes. Exemplos de Diagonalização. Diagonalizando com sympy. </span> \
19 . &nbsp; Ter  --  10/12  --  <span style="color:standard"> Projeção Ortogonal. Bases Ortogonais e Ortonormais. </span> \
20 . &nbsp; Seg  --  16/12  --  <span style="color:standard"> Processo de Ortogonalização de Gram-Schimidt </span> \
21 . &nbsp; Ter  --  17/12  --  <span style="color:standard"> Diagonalização de Matrizes Simétricas </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  23/12  --  Recesso </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Ter  --  24/12  --  Recesso </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  30/12  --  Recesso </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Ter  --  31/12  --  Recesso </span> \
22 . &nbsp; Seg  --  06/01  --  <span style="color:standard"> Mudança de Coordenadas. Rotação e Translação </span> \
23 . &nbsp; Ter  --  07/01  --  <span style="color:standard"> Reconhecimento de Cônicas </span> \
24 . &nbsp; Seg  --  13/01  --  <span style="color:standard"> Aula de Exercícios 2 </span> \
<span style="color:red"> 25 . &nbsp; Ter  --  14/01  --  2ª Prova </span> \
---
...
<span style="color:red"> 26 . &nbsp; Seg  --  20/01  --  2ª Chamada </span> \
27 . &nbsp; Ter  --  21/01  --  <span style="color:standard"> Atendimento </span> \
<span style="color:red"> 28 . &nbsp; Seg  --  27/01  --  VS </span> \
