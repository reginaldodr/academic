...
|Terça   |14h - 16h| Sala 4 (IHS Prédio Alugado)|
: {.striped .table-sm}
...
:lock: @poole **§ 3.1 (Matrizes):** 1, 11, 13, 17, 35.\
:lock: @poole **§ 3.2 (Matrizes):** 1, 4, 23.\
...
- **Álgebra Linear**\
:lock: @poole **§ 1.2 (Vetores em $\mathbb{R}^n$):** 5, 11, 12, 14, 17.\
:lock: @poole **§ 1.3 (Produto Escalar em $\mathbb{R}^n$):** 1, 3, 5, 7, 9, 17, 19, 21, 23, 27, 29, 39, 46, 47, 51.\
...
:lock: @poole **§ 4.5 (Diagonalização):** 11, 13, 15, 17, 21, 25, 27, 40, 41.\ 
...
:lock: **§ 5.4 (Diagonalização Ortogonal):**  1, 3, 5-9, 13, 21, 23, 24.
