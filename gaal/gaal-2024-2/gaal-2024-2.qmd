...
<span style="color:red"> :writing_hand: &nbsp;Entrega dos Para Casa 1: &nbsp; 4, 5, 9, 10,11, 12,13.  &nbsp;  [gabarito](paracasa-gabarito1.pdf) </span> \
06 . &nbsp; Ter  --  22/10  --  <span style="color:standard"> Breve apresentação de Vetores $\mathbb{R}^2$ e $\mathbb{R}^3$.  Produto vetorial. Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  28/10  --  Servidor Público </span> \
07 . &nbsp; Ter  --  29/10  --  <span style="color:LightGray"> a definir   </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  02/11  --  Finados </span> \
08 . &nbsp; Seg  --  04/11  --  <span style="color:LightGray"> Equação paramétrica da reta. Equações Cartesianas da Reta em $\mathbb{R}^2$ (parte 1) </span> \
