...
07 . &nbsp; Ter  --  29/10  --  <span style="color:LightGray"> Equações reduzida e segmentária da reta. Equação cartesiana do plano no espaço. Inteseção de planos.   </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  02/11  --  Finados </span> \
08 . &nbsp; Seg  --  04/11  --  <span style="color:LightGray"> Distância de ponto à Reta. Distância de ponto a Plano. Produto Misto. Volume do Paralelepípedo e do tetraedro. </span> \
...
14 . &nbsp; Seg  --  25/11  --  <span style="color:LightGray"> Posição Relativa de retas e planos.  Distâncias: Entre Retas, entre reta e Plano. </span> \
...
<span style="color:red"> :writing_hand: &nbsp;Entrega dos Para Casa 3: &nbsp;   &nbsp;   </span>  \
...
<span style="color:red"> :writing_hand: &nbsp;Entrega dos Para Casa 4: &nbsp;   &nbsp;   </span>  \
