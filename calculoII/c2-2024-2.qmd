...
03 . &nbsp; Seg  --  07/10  --  <span style="color:standard"> Integração por Partes. Integração por substituição Trigonométrica. Integração de funções racionais: frações parciais. </span> \
04 . &nbsp; Ter  --  08/10  --  <span style="color:LightGray"> Integração de funções racionais: frações parciais. </span> \
...
05 . &nbsp; Seg  --  21/10  --  <span style="color:LightGray"> Área do Círculo. Áreas entre curvas. </span> \
06 . &nbsp; Ter  --  22/10  --  <span style="color:LightGray"> Cálculo de volumes por fatiamento. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  28/10  --  Servidor Público </span> \
07 . &nbsp; Ter  --  29/10  --  <span style="color:LightGray"> Volume pelo método dos discos. Sólidos de Revolução ✊. Volume por cascas cilíndricas. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sáb  --  02/11  --  Finados </span> \
08 . &nbsp; Seg  --  04/11  --  <span style="color:LightGray"> Comprimento de Curvas. O comprimento da circunferência </span> \
09 . &nbsp; Ter  --  05/11  --  <span style="color:LightGray"> Integrais Impróprias: Limites Infinitos. </span> \
10 . &nbsp; Seg  --  11/11  --  <span style="color:LightGray"> Integrais Impróprias: Integrandos Descontínuos.  </span> \
11 . &nbsp; Ter  --  12/11  --  <span style="color:LightGray"> Teste de comparação. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sex  --  15/11  --  Proclamação da República </span> \
12 . &nbsp; Seg  --  18/11  --  <span style="color:LightGray"> Aula de Exercícios 1 </span> \
