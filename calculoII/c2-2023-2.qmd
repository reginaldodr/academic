...
11 . &nbsp; Sex  --  06/10  --  <span style="color:LightGray"> Volume pelo método dos discos. Sólidos de Revolução.  Volume por cascas cilíndricas, Comprimento de Curvas </span> \
12 . &nbsp; Sex  --  11/10  --  <span style="color:LightGray"> Volume pelo método dos discos. Sólidos de Revolução.  Volume por cascas cilíndricas, Comprimento de Curvas </span> \
...
<span style="color:red"> 13 . &nbsp; Qua  --  25/10  --  1ª Prova </span> \
14 . &nbsp; Sex  --  27/10  --  <span style="color:LightGray">  EDOs: modelos (populacionais, massa-mola, pêndulo, queda livre com resistência do ar).  Classificação e solução. Campos direcionais. Equações Separáveis 1ª ordem, EDO 1ª ordem linear </span> \
