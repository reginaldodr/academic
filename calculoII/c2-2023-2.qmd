...
14 . &nbsp; Sex  --  27/10  --  EDOs: modelos (populacionais, massa-mola, pêndulo, queda livre com resistência do ar).  Classificação e solução.  \
<span style="color:orange"> XX . &nbsp; Sáb  --  28/10  --  Servidor Público </span> \
15 . &nbsp; Qua  --  01/11  --  <span style="color:LightGray"> Campos direcionais. Equações Separáveis 1ª ordem, EDO 1ª ordem linear. Equações Exatas. Teorema de Existência e Unicidade de Soluções para EDO de 1ª ordem lineares </span> \
