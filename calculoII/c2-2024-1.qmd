...
notafinal = np.array([0,2.1,4.8,4,6,8.6,4,7.1,6,8.3,1.9,6.2,7.2,4.3,4,2.9,10,4.6,2.6,3.3,0,9.9,6,1.5,4.3,9.7,6.9,6.2,1.5,5.3,9.9,6.5,10,0,7.4,4.5,8.3])
...
res2, _ = np.histogram(notaparcial, bins=bins2)
...
mylabels = ["Reprovados", "VS", "Aprovados"]
...
mylabels2 = ["Reprovados", "Aprovados"]
...
# Plot the histogram.
plt.hist(notafinal, bins=5, density=False, alpha=0.6, color='b',edgecolor='black')
