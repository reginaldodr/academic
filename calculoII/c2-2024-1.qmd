...
11 . &nbsp; Seg  --  08/07  --  <span style="color:black"> Equações Exatas.  Teoremas de Existência e Unicidade de Soluções para EDO de 1ª ordem. </span> \
12 . &nbsp; Ter  --  09/07  --  <span style="color:LightGray">EDO’s 2ª ordem lineares. Teorema de Existência e Unicidade. Soluções Fundamentais. Wronskiano </span> \
13 . &nbsp; Seg  --  15/07  --  <span style="color:LightGray"> Oscilações mecânicas livres com amortecimento. EDO 2ª ord. linear homogênea com coef. constantes - caso raízes distintas </span> \
---

**2.2 EDOs de 2ª ordem lineares**

14 . &nbsp; Ter  --  16/07  --  <span style="color:LightGray">a definir </span> \
15 . &nbsp; Seg  -- 22/07  --   <span style="color:LightGray"> Oscilações mecânicas livres com amortecimento. EDO 2ª ord. linear homogênea com coef. constantes - caso raízes distintas </span> \
16 . &nbsp; Ter  -- 23/07  --  <span style="color:LightGray"> EDO linear homogênea com coeficientes constantes - caso raízes reais iguais. Revisão de números complexos e fórmula de Euler </span> \
