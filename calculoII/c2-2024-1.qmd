...
03 . &nbsp; Seg  --  25/03  --  <span style="color:Black"> Integração por substituição Trigonométrica. Integração de funções racionais por frações parciais: Denominador como produto de fatores lineares distintos. </span> \
04 . &nbsp; Ter  --  26/03  --  <span style="color:Black"> Aula de Exercícios. </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Sex  --  29/03  --  Sexta-feira da Paixão </span> \
---

**1.2 Aplicações da Integral**

05 . &nbsp; Seg  --  01/04  --  <span style="color:Black"> Áreas entre curvas. Cálculo de volumes por fatiamento. Volume pelo método dos discos. Sólidos de Revolução :fist: </span> \
06 . &nbsp; Ter  --  02/04  --  <span style="color:Black"> Volume por cascas cilíndricas. Comprimento de Curvas. O comprimento da circunferência.  </span> \
07 . &nbsp; Seg  --  08/04  --  <span style="color:Black"> Integrais Impróprias: Limites Infinitos.  </span> \
08 . &nbsp; Ter  --  09/04  --  <span style="color:Black"> Integrais Impróprias: Integrandos Descontínuos. Teste da comparação. </span> \
...
09 . &nbsp; Seg  --  29/04  --  <span style="color:LightGray"> Teste de comparação no limite. Aula de Exercícios. </span> \
10 . &nbsp; Ter  --  30/04  --  <span style="color:LightGray"> Aula de Exercícios 1 </span> \
...
11 . &nbsp; Seg  --  06/05  --  <span style="color:LightGray"> EDOs: modelos (populacionais, massa-mola, pêndulo, queda livre com resistência do ar) </span> \
12 . &nbsp; Ter  --  07/05  --  <span style="color:LightGray"> Classificação e solução. Campos direcionais. Equações Separáveis 1ª ordem, EDO 1ª ordem linear </span> \
13 . &nbsp; Seg  --  13/05  --  <span style="color:LightGray"> Equações Exatas e fator integrante. </span> \
14 . &nbsp; Ter  --  14/05  --  <span style="color:LightGray"> Teorema de Existência e Unicidade de Soluções para EDO de 1ª ordem lineares </span> \
15 . &nbsp; Seg  --  20/05  --  <span style="color:LightGray"> Aula de Exercícios 2 </span> \
---

**2.2 EDOs de 2ª ordem lineares**

16 . &nbsp; Ter  --  21/05  --  <span style="color:LightGray"> EDO’s 2ª ordem lineares. Teorema de Existência e Unicidade. Soluções Fundamentais. Wronskiano </span> \
17 . &nbsp; Seg  --  27/05  --  <span style="color:LightGray"> Oscilações mecânicas livres com amortecimento. EDO 2ª ord. linear homogênea com coef. constantes - caso raízes distintas </span> \
18 . &nbsp; Ter  --  28/05  --  <span style="color:LightGray"> EDO linear homogênea com coeficientes constantes - caso raízes reais iguais. Revisão de números complexos e fórmula de Euler </span> \
...
19 . &nbsp; Seg  --  03/06  --  <span style="color:LightGray"> EDO linear homogênea com coeficientes constantes -  Caso raízes complexas.Método dos coeficientes a determinar </span> \
20 . &nbsp; Ter  --  04/06  --  <span style="color:LightGray"> Método da variação dos Parâmetros </span> \
21 . &nbsp; Seg  --  10/06  --  <span style="color:LightGray"> Método da variação dos Parâmetros </span> \
22 . &nbsp; Ter  --  11/06  --  <span style="color:LightGray"> Aula de Exercícios 3 </span> \
23 . &nbsp; Seg  --  17/06  --  <span style="color:LightGray"> Aula de Dúvidas </span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
---

**Provas Finais**

<span style="color:red"> 24 . &nbsp; Ter  --  18/06  --  Prova da Matéria Toda </span> \
<span style="color:red"> 25 . &nbsp; Seg  --  24/06  --  2ª Chamada </span> \
26 . &nbsp; Ter  --  25/06  --  <span style="color:LightGray"> Semana dedicada à preparação para a VS </span> \
27 . &nbsp; Seg  --  01/07  --  <span style="color:LightGray"> Semana dedicada à preparação para a VS </span> \
<span style="color:red"> 28 . &nbsp; Ter  --  02/07  --  VS </span> \
29 . &nbsp; Seg  --  08/07  --   --  \
30 . &nbsp; Ter  --  09/07  --   --  \
31 . &nbsp; Seg  --  15/07  --   --  \
32 . &nbsp; Ter  --  16/07  --   --  \
