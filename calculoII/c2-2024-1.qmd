...
09 . &nbsp; Seg  --  01/07  --  <span style="color:black"> Apresentação do novo planejamento. EDO: Classificação. Solução. PVI. Modelo Populacional Malthusiano. </span> \
10 . &nbsp; Ter  --  02/07  --  <span style="color:LightGray"> EDO 1ª ordem. Campos direcionais. Equações Separáveis, EDO 1ª ordem linear</span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
11 . &nbsp; Seg  --  08/07  --  <span style="color:LightGray"> Classificação e solução. Campos direcionais. Equações Separáveis 1ª ordem, EDO 1ª ordem linear </span> \
12 . &nbsp; Ter  --  09/07  --  <span style="color:LightGray"> Equações Exatas e fator integrante. </span> \
13 . &nbsp; Seg  --  15/07  --  <span style="color:LightGray"> Teorema de Existência e Unicidade de Soluções para EDO de 1ª ordem lineares </span> \
---

**2.2 EDOs de 2ª ordem lineares**

14 . &nbsp; Ter  --  16/07  --  <span style="color:LightGray"> EDO’s 2ª ordem lineares. Teorema de Existência e Unicidade. Soluções Fundamentais. Wronskiano </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Seg  --  22/07  --  Não haverá aula </span> \
:beach_umbrella: <span style="color:orange"> &nbsp; Ter  --  23/07  --  Não haverá aula </span> \
15 . &nbsp; Seg  --  29/07  --  <span style="color:LightGray"> Oscilações mecânicas livres com amortecimento. EDO 2ª ord. linear homogênea com coef. constantes - caso raízes distintas </span> \
16 . &nbsp; Ter  --  30/07  --  <span style="color:LightGray"> EDO linear homogênea com coeficientes constantes - caso raízes reais iguais. Revisão de números complexos e fórmula de Euler </span> \
17 . &nbsp; Seg  --  05/08  --  <span style="color:LightGray"> EDO linear homogênea com coeficientes constantes -  Caso raízes complexas.Método dos coeficientes a determinar </span> \
18 . &nbsp; Ter  --  06/08  --  <span style="color:LightGray"> Método da variação dos Parâmetros </span> \
<span style="color:red"> :writing_hand: &nbsp; Entrega dos Para Casa :house: na próxima aula </span> \
---
